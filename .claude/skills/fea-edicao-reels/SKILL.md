...
| Título | Montserrat ExtraBold 140 px, branco, contorno preto 5 px, centro exato do quadro, até 3 linhas de ~16 caracteres, **linhas juntas** (entrelinha 0,8 do tamanho da fonte, `TITULO_ENTRELINHA`; ajuste de 26/09/2026, a entrelinha padrão da Montserrat ficou aberta demais). A quebra usa a largura real da fonte: até 4 linhas, reduz até 125 px antes de criar mais uma linha e só encolhe abaixo disso quando a headline é longa; nunca separa "Black Friday" nem datas ("20 de outubro") e quebra depois de dois-pontos, nos **3 primeiros segundos** |
